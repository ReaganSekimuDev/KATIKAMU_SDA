...
function UpdateDoc(index) {
    ...
    uPe2 = pe2
    uKis1 = kis1
    // phyTxt1.value = (studentsArray[index].marks.phy/2)
    // phyTxt2.value = (studentsArray[index].marks.phy/2)
    // chemTxt1.value = (studentsArray[index].marks.chem/2)
    // chemTxt2.value = (studentsArray[index].marks.chem/2)
    // mathsTxt1.value = (studentsArray[index].marks.maths)
    // bioTxt1.value = (studentsArray[index].marks.bio/2)
    // bioTxt2.value = (studentsArray[index].marks.bio/2)
    // geogTxt1.value = (studentsArray[index].marks.geog)
    // hisTxt1.value = (studentsArray[index].marks.his)
    // ictTxt1.value = (studentsArray[index].marks.ict/2)
    // ictTxt2.value = (studentsArray[index].marks.ict/2)
    // entTxt1.value = (studentsArray[index].marks.ent)
    // agricTxt1.value = (studentsArray[index].marks.agric/2)
    // agricTxt2.value = (studentsArray[index].marks.agric/2)
    // creTxt1.value = (studentsArray[index].marks.cre)
    // ireTxt1.value = (studentsArray[index].marks.ire)
    // peTxt1.value = (studentsArray[index].marks.pe/2)
    // peTxt2.value = (studentsArray[index].marks.pe/2)
    // kisTxt1.value = (studentsArray[index].marks.kis)
